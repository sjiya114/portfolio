            ...
            <footer className="flex flex-col bg-black text-white    items-center justify-around w-full py-16 text-sm">
                <div className="flex items-center gap-4 mt-8 text-indigo-500">
                    <Link href="https://leetcode.com/u/sjiya2004/" className="hover:-translate-y-0.5 transition-all duration-300">
                        <Image src="/leetcode.svg" width={24} height={24} className="bg-gray-700 rounded-full px-1 py-1" alt="leetcode"></Image>
                    </Link>
                    <Link href="https://www.instagram.com/jiyaa414/" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <Link href="https://www.linkedin.com/in/jiya-sharma-a0543b257" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="https://x.com/JiyaSharma87903" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="https://github.com/sjiya114" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="mt-8 text-center"><Link href="https://prebuiltui.com">Built with love by Jiya Sharma</Link></p>
            </footer>
        </>
    );
};